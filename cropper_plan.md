...
4.  **Cropping Interface:**
    ...
    - **Interaction:** Drag to move, handles to resize (maintaining aspect ratio).
5.  **Saving:**
    - `Crop` button saves the current selection to a `cropped` sub-folder.
...
- **Side/Top Panel:** Aspect Ratio dropdown, Width/Height inputs.
